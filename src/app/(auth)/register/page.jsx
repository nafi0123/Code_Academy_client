        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            <div><label>Name</label>
              <input type="text" value={name} onChange={e=>setName(e.target.value)} className="input input-bordered w-full mt-1 bg-white" placeholder="Enter your name"/>
            </div>
            ...
            <div><label>Password</label>
              <input type="password" value={password} onChange={e=>setPassword(e.target.value)} className="input input-bordered w-full mt-1 bg-white" placeholder="Enter your password"/>
            </div>
            <button type="submit" className="btn w-full bg-indigo-600 text-white">{loading?"Loading...":"Register"}</button>
          </form>
